	...
	class Video {
		...
		public function update()
		{
			...
			foreach ($arr as $w) {
				...
				$videourl = "http://screen.jfjb.com.cn/jfjb/Public/cache1/video/".$fold."/1.mp4";
				$picPath   = $this ->fold.DIRECTORY_SEPARATOR.$fold."\\1.jpg";
				$picurl = "http://screen.jfjb.com.cn/jfjb/Public/cache1/video/".$fold."/1.jpg";
				
                //如果视频下载成功
				//$ret1 = \App\Wsn\Download::downurl($w['video'],$videoPath);
				$ret1 = \App\Wsn\Download::downurl($videourl,$videoPath);
				$ret2 = \App\Wsn\Download::download($picurl,$picPath);
				if($ret1['code']==0 && $ret2==true)
				{
