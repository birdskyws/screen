...
(function(factory) {
  ...
  var getBrowserDetection = function() {
    ...
    // d.cantouch = ("ontouchstart" in document.documentElement) || ("ontouchstart" in window);  //修改电脑版
    d.cantouch = ("click" in document.documentElement) || ("click" in window); // detection for Chrome Touch Emulation
        ...
        if (cap.isie9mobile) {
          ...
          if (cap.cantouch || self.istouchcapable || self.opt.touchbehavior || cap.hasmstouch) {
            ...
            self.ontouchstart = function(e) {
              ...
              // if (e.pointerType && e.pointerType != 2 && e.pointerType != "click") return false;
    ...
    this.bind = function(dom, name, fn, bubble) { // touch-oriented & fixing jquery bind
      ...
      if (name == 'mousewheel') {
        ...
        if (cap.cantouch && /mouseup|mousedown|mousemove/.test(name)) { // touch device support
          var tt = (name == 'mousedown') ? 'touchstart' : (name == 'click') ? 'touchend' : 'touchmove';
